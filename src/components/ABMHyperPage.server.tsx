/**
 * ABMHyperPage — Server-Side Rendered version
 *
 * Static HTML output for SEO indexing. No useEffect hooks, no canvas elements,
 * no animation imports. Mirrors the client component structure exactly so
 * hydration can take over seamlessly.
 */
...
const ABMHyperPageServer = ({ page }: Props) => {
  ...
  return (
    <main className="abm-page" id="main-content">
      ...
      {/* No warp-canvas in SSR — requires browser canvas API */}
...
export default ABMHyperPageServer;
